    ...
    <footer className="bg-[#0c1b33] text-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between">
        ...
        <div className="mt-4 sm:mt-0">
          <p className="text-md font-semibold mb-2">Social Links</p>
      ...
      {/* Horizontal Line */}
      <hr className="border-t border-silver mx-auto w-[90%]" />

      {/* Lower Div: Copyright */}
      <div className="max-w-7xl mx-auto px-6 py-4 text-center text-sm text-gray-400 select-none">
